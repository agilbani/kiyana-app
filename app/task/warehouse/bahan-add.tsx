import { SelectInput, ThemedContainer, ThemedHeader, ThemedText } from "@/components";
import {
    addMaterial,
    getMaterialOne,
    getMaterialVariant,
...
const BahanAdd: React.FC = () => {
  ...
  const handlePickImage = async (index: number) => {
    ...
    if (status !== "granted") {
      Alert.alert("Izin diperlukan", "Berikan izin akses galeri untuk memilih gambar.");
      return;
    }
  ...
  const handleAddVariant = () => {
    setForm((prev) => ({
      ...prev,
      variants: [...prev.variants, { color_id: "", price: "", stock: "", min_stock: "" }],
    }));
  };
  ...
  return (
    <ThemedContainer>
      <ThemedHeader
        title={
          isAdd ? "Tambah Material" : isEdit ? "Edit Material" : "Detail Material"
        }
      />
          ...
          {form.variants.map((v, i) => (
            <View key={i} style={styles.variantBox}>
              <View style={styles.variantHeader}>
                <ThemedText type="SemiBold">Varian {i + 1}</ThemedText>
              ...
              <SelectInput
                ...
                onSelect={(val) => handleVariantChange(i, "color_id", val)}
              />
              ...
              <View style={{ marginTop: 6 }}>
                ...
                {v.preview ? (
                  ...
                  !isView && (
                    ...
                    >
                      <ThemedText color="#2563eb">＋ Pilih Gambar</ThemedText>
                    </TouchableOpacity>
                  )
                )}
              </View>
              ...
              <TextInput
                ...
                value={v.price}
                onChangeText={(t) => handleVariantChange(i, "price", t)}
                style={[styles.input, isView && styles.disabled]}
              />
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={v.min_stock}
                onChangeText={(t) => handleVariantChange(i, "min_stock", t)}
                style={[styles.input, isView && styles.disabled]}
              />
            </View>
          ))}
