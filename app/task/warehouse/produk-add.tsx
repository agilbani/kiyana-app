    ...
    const fetchDetail = useCallback(async () => {
        ...
        try {
            ...
            setForm({
                ...
                productMaterials: data.product_materials?.map((m: any) => ({
                    id: m.id, // buat update
