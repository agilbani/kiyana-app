  ...
  return (
    <ThemedContainer>
      ...
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <View style={GlobalStyles.center}>
            ...
            <ThemedGap height="sm" />
            <ThemedText type="SemiBold" size="sm" color={Color.Gray[600]}>
              Unggah Foto
            </ThemedText>
            ...
            <ThemedText
              ...
              style={[GlobalStyles.center, { paddingHorizontal: scale(68) }]}
            >
              Format harus .jpeg atau .png dengan ukuran minimal 800x800px dan
              maksimal 5MB
            </ThemedText>
          </View>
          <ThemedGap height="md" />
      ...
      <View style={styles.footer}>
        <ThemedButton title="Perbarui" onPress={() => ref.current?.show()} />
      </View>
      ...
      <ThemedBottomSheet ref={ref} onClose={() => ref.current?.hide()}>
        ...
        <ThemedText type="Medium" size="md" color={Color.Text.Secondary}>
          Apakah Anda yakin ingin memperbarui profil? Ini akan membantu kami
          meningkatkan pengalaman Anda dan menyediakan fitur yang
          dipersonalisasi.
        </ThemedText>
        <ThemedGap height="xl" />
