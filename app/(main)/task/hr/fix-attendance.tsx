    ...
    <ThemedContainer>
      ...
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <ThemedText type="Regular" size="sm" color={Color.Gray[500]}>
            Lengkapi informasi berikut untuk mengajukan perbaikan absensi.
          </ThemedText>
          <ThemedGap height="lg" />

          <ThemedDatePicker label="Tanggal Absensi" />
          <ThemedGap height="md" />
          <ThemedInput label="Jam Masuk" placeholder="Contoh: 08:00" />
          <ThemedGap height="md" />
          <ThemedInput label="Jam Keluar" placeholder="Contoh: 17:00" />
          <ThemedGap height="md" />
          <ThemedTextarea
            label="Catatan"
      ...
      <ThemedBottomSheet ref={ref} onClose={() => ref.current?.hide()}>
        ...
        <ThemedText type="Medium" size="md" color={Color.Text.Secondary}>
          Apakah kamu yakin ingin mengajukan perbaikan absensi ini? Pastikan
          semua data yang dimasukkan sudah benar.
        </ThemedText>
        <ThemedGap height="xl" />
        <ThemedButton title="Ya, Ajukan Sekarang" onPress={handleConfirm} />
        <ThemedGap height="md" />
        <ThemedButton
          variant="outline"
          title="Batal"
