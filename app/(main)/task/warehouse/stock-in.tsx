...
const StockInScreen = () => {
  ...
  const [stockInList, setStockInList] = useState<BatchInput[]>([]);
  ...
  const handleAddItem = () => {
    ...
    setStockInList((prev) => [...prev, currentItem]);
    setCurrentItem({ barcode: "", qty_done: 0, notes: "" });
  };

  const handleSubmit = () => {
    console.log("Submit Barang Masuk:", stockInList);
  };
  ...
  return (
    <View style={styles.page}>
      ...
      <ThemedHeader title="Catat Barang Masuk" />
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={{ marginVertical: scale(80) }}>
              ...
              >
                Belum ada barang masuk dicatat
              </ThemedText>
            </View>
          }
        />
