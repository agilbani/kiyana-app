...
import { ThemedSelectProps, ThemedSelectState } from "@/types/components";
...
import { ThemedBottomSheet } from "../feedback";
import { ThemedKeyboardAvoiding } from "../layout";
                        ...
                        <View style={styles.outerContainer}>
                            <View
                                style={[
                                    ...
                                    {
                                        borderColor:
                                            stylesComputed.innerBorderColor,
                                        backgroundColor:
