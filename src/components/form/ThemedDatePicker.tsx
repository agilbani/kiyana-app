...
> {
    ...
    onDateChange = (_: any, selectedDate?: Date) => {
        ...
        const formattedDate = currentDate
            ? moment(currentDate).locale("id").format("DD-MM-YYYY")
            : "";
        this.setState({
            showPicker: Platform.OS === "ios",
            value: currentDate,
        });
        this.props.onChange?.(formattedDate ?? new Date());
    };
    ...
    render() {
        const { error, disabled, label, labelSize, type = "date" } = this.props;
            ...
            <View>
                        ...
                        <View
                            style={[
                                styles.container,
                                {
                                    ...
                                    backgroundColor:
                                        stylesComputed.backgroundColor,
                                },
                ...
                {showPicker && (
                    <DateTimePicker
                        ...
                        display="default"
                        minimumDate={
                            this.props.minimumDate ? new Date() : undefined
                        }
