        ...
        <View style={styles.headerContent}>
          <View style={GlobalStyles.rowSpaceBetween}>
            <View style={styles.headerTextContainer}>
              ...
              <ThemedText type="Medium" size="md" color={Color.Purple[200]}>
          ...
          <View style={[styles.card, GlobalStyles.shadow]}>
            ...
            <ThemedText type="Regular" size="sm" color={Color.Text.Secondary}>
            ...
            <View style={GlobalStyles.rowCenter}>
              <View style={styles.cardClock}>
                ...
                <ThemedGap height="xs" />
                <ThemedText size="xl">{clockInTime ?? "--:--"}</ThemedText>
              </View>
              <ThemedGap width="xs" />
              <View style={styles.cardClock}>
                <View style={GlobalStyles.rowCenter}>
                ...
                <ThemedGap height="xs" />
                <ThemedText size="xl">{clockOutTime ?? "--:--"}</ThemedText>
              </View>
            </View>
            <ThemedGap height="sm" />
            <ThemedButton
              title={clockInTime ? "Absen Pulang" : "Absen Masuk"}
